                    ...
                    <div class="card">
                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-title">
                                ...
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" data-kt-user-table-filter="search"
                                        class="form-control form-control-solid w-250px ps-14" placeholder="Search kriteria"
                                        id="kt_table_search" />
                                </div>
                                <!--end::Search-->
                            </div>
                            ...
                            <div class="card-toolbar">
                                ...
                                {{-- @include('topsis.modal-create-edit') --}}
                                <!--end::Modal - Add task-->
                            </div>
                            <!--end::Card toolbar-->
                        </div>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_data_penerima">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-100px">Penghasilan Perbulan</th>
                                        <th class="min-w-100px">Bobot P</th>
                                        <th class="min-w-100px">Jumlah Anggota Keluarga</th>
                                        <th class="min-w-100px">Bobot AK</th>
                                        <th class="min-w-100px">Pekerjaan</th>
                                        <th class="min-w-100px">Bobot P</th>
                                        <th class="min-w-100px">Jenis Lantai</th>
                                        <th class="min-w-100px">Bobot JL</th>
                                        <th class="min-w-100px">Jenis Dinding</th>
                                        <th class="min-w-100px">Bobot JD</th>
