$(document).ready(function () {
    ...
    var modal = $("#kt_modal_add_warga");
    var modal_title = $("#kt_modal_add_warga .form-title-modal");
    ...
    var validation_form = FormValidation.formValidation(form_modal[0], {
        fields: {
            ...
            kepala_keluarga: {
                validators: {
                    notEmpty: {
                        message: "Kepala Keluarga is required",
                    },
                },
            },
            rt: {
        ...
        if (method == "create") {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#input-kepala-keluarga").val(data.kepala_keluarga);
                    $("#input-rt").val(data.rt);
                    $("#input-rw").val(data.rw);
